...
function LoginPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setError('');
        setLoading(true);
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$authService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signIn"])(email, password);
        if (result.success) {
            router.push('/admin');
        } else {
...
//# sourceMappingURL=_a3aa7693._.js.map